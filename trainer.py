...
split=True   #Seperate charge and energy networks

damping=True #Dampen coulombic interactions at short ranges

repuls=True  #Add short range repulsion energy



data_path='/data/cdever01/torch_train/dipol_training/batched_2x_3/some_data/'                 #Path to prebatched data
...
out_size = 2          #Only needed if split=False
...
#Multi task learning loss. Optimize the relative weight of each objective
